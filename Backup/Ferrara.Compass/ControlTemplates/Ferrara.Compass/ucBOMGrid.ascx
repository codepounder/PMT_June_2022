...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucBOMGrid.ascx.cs" Inherits="Ferrara.Compass.ControlTemplates.Ferrara.Compass.ucBOMGrid" %>

<h3 class="accordion">
    <asp:Label ID="lblTitle" ClientIDMode="Static" CssClass="titlelbl" runat="server"></asp:Label>
    <asp:Label ID="lblDesc" runat="server"></asp:Label></h3>
            ...
            <asp:Repeater ID="rptPackingItem" runat="server" OnItemCommand="rptPackingItem_ItemCommand" OnItemDataBound="rptPackingItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr id="dvPackingItemRow" class="bomrow" style="<%# Container.ItemIndex % 2 == 0 ? "": "background-color:#BCD3F2;" %>">
                        <td class="BOMEdit">
                            <asp:ImageButton ID="test" CausesValidation="false" Height="16" Width="16" CssClass="select" AlternateText="Select" OnClientClick="hideSelectButton('Select');" CommandName="LoadControl" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>' ImageUrl="/_layouts/15/Ferrara.Compass/images/Edit.gif" runat="server" />
