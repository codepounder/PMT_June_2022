...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucTransferSemiBOMs.ascx.cs" Inherits="Ferrara.Compass.ControlTemplates.Ferrara.Compass.ucTransferSemiBOMs" %>

<asp:Repeater ID="rptTransferSemi" runat="server" OnItemDataBound="rptTransferSemi_ItemDataBound">
<ItemTemplate>
    <h3 class="accordion"><asp:Label ID="lblHeaderText" runat="server" Text=""></asp:Label>: <%# DataBinder.Eval(Container.DataItem, "MaterialNumber") + " " + DataBinder.Eval(Container.DataItem, "MaterialDescription") %></h3>
                ...
                <table class="gridTable">
                    <asp:Repeater ID="rptTransferSemiChildren" runat="server">
                        <HeaderTemplate>
                            ...
                            <th class="gridCellH gridRow2">Pack Quantity</th>
                        ...
                        <ItemTemplate>
                            ...
                            <td class="gridCell"><asp:Label CssClass="summary" ID="Label1" runat="server"
                                Text='<%# DataBinder.Eval(Container.DataItem, "PackQuantity") %>'></asp:Label></td>
