        ...
        init : function (parameters) {
            ...
            return this.each(function () {
                ...
                function maskValue(value) {
                    ...
                    var pointPosition = onlyNumbers.indexOf('.');
                    var newValue, integerPart, decimalPart, pointPosition2, precision, zeros = '';

                    if (pointPosition >= 0) {
                        pointPosition2 = onlyNumbers.indexOf('.', pointPosition + 1);
                        if (pointPosition2 >= 0)
                            onlyNumbers = onlyNumbers.substr(0, pointPosition2);
                    }
                    else {
                        onlyNumbers += '.';
                        pointPosition = onlyNumbers.indexOf('.');
                    }
                    ...
                    if (settings.precision > 0) {
                        decimalPart = onlyNumbers.slice(pointPosition, pointPosition + settings.precision + 1);
                        if (precision + 1 > decimalPart.length)
                            zeros = new Array(precision + 1 - decimalPart.length).join(0);
