...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AllProjectDetailsDashboard.ascx.cs" Inherits="Ferrara.Compass.WebParts.AllProjectDetailsDashboard.AllProjectDetailsDashboard" %>
...
<script type="text/javascript" src="/_layouts/15/Ferrara.Compass/js/Compass.js?v=1136"></script>
...
<script type="text/javascript">
    $(document).ready(function () {
        AllProjectDetailsDisplay("&$filter=(WorkflowPhase ne 'Completed' and WorkflowPhase ne 'On Hold' and WorkflowPhase ne 'Cancelled')");
        $('#ProjectStatusFilter').on('change', function () {
            ...
            if (filterVal == "All Open") {
                ...
                AllProjectDetailsDisplay("&$filter=(WorkflowPhase eq 'Completed')");

            } else if (filterVal == "Cancelled") {
                AllProjectDetailsDisplay("&$filter=(WorkflowPhase eq 'Cancelled')");

            } else if (filterVal == "On Hold") {
                AllProjectDetailsDisplay("&$filter=(WorkflowPhase eq 'On Hold')");
