...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AllProjectDetailsDashboard2.ascx.cs" Inherits="Ferrara.Compass.WebParts.AllProjectDetailsDashboard2.AllProjectDetailsDashboard2" %>
...
<link href="/_layouts/15/Ferrara.Compass/css/Compass-Blue.css?v=8" type="text/css" rel="Stylesheet" />
...
<script type="text/javascript">
    $(document).ready(function () {
        AllProjectDetailsDisplay2("&$filter=(WorkflowPhase ne 'Completed' and WorkflowPhase ne 'On Hold' and WorkflowPhase ne 'Cancelled')");
        $('#ProjectStatusFilter').on('change', function () {
            ...
            if (filterVal == "All Open") {
                ...
                AllProjectDetailsDisplay2("&$filter=(WorkflowPhase eq 'Completed')");

            } else if (filterVal == "Cancelled") {
                AllProjectDetailsDisplay2("&$filter=(WorkflowPhase eq 'Cancelled')");

            } else if (filterVal == "On Hold") {
                AllProjectDetailsDisplay2("&$filter=(WorkflowPhase eq 'On Hold')");
