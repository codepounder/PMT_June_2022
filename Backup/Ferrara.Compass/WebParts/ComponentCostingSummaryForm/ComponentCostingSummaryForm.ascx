...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ComponentCostingSummaryForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.ComponentCostingSummaryForm.ComponentCostingSummaryForm" %>
            ...
            <div class="row" style="margin-top:0px; <%# Container.ItemIndex % 2 == 0 ? "" : "background-color:#BCD3F2;" %>">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        ...
                        <a target="_blank" id="ancCostingQuote" runat="server"></a>
                        <asp:panel id="divCostQuoteStatus" runat="server"></asp:panel>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        ...
                        <asp:Textbox ID="txtQuoteDate" runat="server" CssClass="form-control" BorderStyle="None" ReadOnly="true" Text='<%# DataBinder.Eval(Container.DataItem, "MaterialDescription") %>' ></asp:Textbox>
                    </div>
                </div>
            </div>
        </ItemTemplate>
