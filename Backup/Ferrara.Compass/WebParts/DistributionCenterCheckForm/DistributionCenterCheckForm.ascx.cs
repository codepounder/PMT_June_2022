...
namespace Ferrara.Compass.WebParts.DistributionCenterCheckForm
{
    [ToolboxItemAttribute(false)]
    public partial class DistributionCenterCheckForm : WebPart
    {
        ...
        public DistributionCenterCheckForm()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    LoggingService.LogError(LoggingService.WebPartLoggingDiagnosticArea, CompassForm.DistributionCenterCheck.ToString() + ": " + exception.Message);
                    exceptionService.Handle(LogCategory.CriticalError, exception, CompassForm.DistributionCenterCheck.ToString(), "Page_Load");
                }
            }
            else
            {
        ...
        private void InitializeScreen()
        {
            ...
            if (!userMgmtService.HasReadAccess(CompassForm.DistributionCenterCheck))
            {
            ...
            if (!userMgmtService.HasWriteAccess(CompassForm.DistributionCenterCheck))
            {
        ...
        private void LoadFormData()
        {
            ...
            this.lblDesignateHUBDC.Text = item.DesignateHUBDC;
