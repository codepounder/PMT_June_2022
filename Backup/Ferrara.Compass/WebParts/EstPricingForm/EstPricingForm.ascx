...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EstPricingForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.EstPricingForm.EstPricingForm" %>
...
<div class="container" id="dvMain" runat="server">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
                <span class="markrequired">*</span><label class="control-label">Initial Pricing Entered:</label>
                <asp:CheckBox ID="chkInitialEstimatedPricing" ClientIDMode="Static" runat="server" CssClass="PricingCheck required"></asp:CheckBox>
            </div>
        </div>
    </div>
    <div class="row">
