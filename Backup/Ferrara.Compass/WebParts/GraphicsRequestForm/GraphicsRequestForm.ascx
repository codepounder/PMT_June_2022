...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GraphicsRequestForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.GraphicsRequestForm.GraphicsRequestForm" %>
...
<div class="container">
                ...
                <asp:Repeater ID="rptSummary" runat="server" OnItemDataBound="rptSummary_ItemDataBound">
                    <HeaderTemplate>
                        <tr>
                            ...
                            <th class="gridCellH">Material (Packaging) Number:</th>
                    ...
                    <ItemTemplate>
                        <tr <%# Container.ItemIndex % 2 == 0 ? "" : "class=\"gridRow2\""%>>
                            ...
                            <td class="gridCell"><%# DataBinder.Eval(Container.DataItem, "VendorMaterialNumber") %></td>
                            ...
                            <td class="gridCell">
                                <table>
                                    <asp:Repeater ID="rptDieLines" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:HyperLink ID="ancDieLine" runat="server" Target="_blank"
                                                        NavigateUrl='<%# Eval("FileUrl") %>' Text='<%# Eval("FileName") %>'></asp:HyperLink></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </table>
                            ...
                            <td class="gridCell">
                                <asp:HyperLink ID="ancGR" runat="server">Graphics Request</asp:HyperLink></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            </table>
        ...
        <asp:Repeater ID="rptGraphics" runat="server" OnItemDataBound="rptGraphics_ItemDataBound" OnItemCommand="rptGraphics_ItemCommand">
            <ItemTemplate>
                ...
                <div class="row" style="margin-top: 0px; <%# Container.ItemIndex % 2 == 0 ? "": "background-color:#BCD3F2;" %>">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <label class="control-label">Component Notes (PE):</label>
                            <asp:TextBox ID="lblComponentNotes" runat="server" CssClass="form-control" BorderStyle="None" ReadOnly="true" Text='<%# DataBinder.Eval(Container.DataItem, "Notes") %>'></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top: 0px; <%# Container.ItemIndex % 2 == 0 ? "": "background-color:#BCD3F2;" %>">
                ...
                <div class="row" style="margin-top: 0px; <%# Container.ItemIndex % 2 == 0 ? "": "background-color:#BCD3F2;" %>">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            <div>
                                <a target="_blank" id="ancDieline1" runat="server"></a>
                            </div>
                            <div>
                                <a target="_blank" id="ancDieline2" runat="server"></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row" style="margin-top: 35px; margin-left: 10px;">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <asp:Label ID="lblNoPalletPattern" runat="server" Text="No Pallet Pattern Attachments Found!" Visible="false" CssClass="control-label"></asp:Label>
            <table>
