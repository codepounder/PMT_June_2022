...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemProposalForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.ItemProposalForm.ItemProposalForm" %>
            ...
            <div id="wizard" class="wizard clearfix">
                ...
                <div class="content clearfix">
                    ...
                    <section id="wizard-h-4">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label class="control-label"><span class="markrequired">*</span>List Price B1 per Selling Unit:</label>
                ...
                <div class="form-group">
                    ...
                    <section id="wizard-h-12">
                        ...
                        <div class="row HideForSNM HideGraphics">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <span class="LabelControl">List Price B1 per Selling Unit:</span>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-2">
...
<script type="text/javascript" src="/_layouts/15/Ferrara.Compass/js/IPF.js?v=139"></script>
<script>
