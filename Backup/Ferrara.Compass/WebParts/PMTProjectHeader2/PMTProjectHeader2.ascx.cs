...
namespace Ferrara.Compass.WebParts.PMTProjectHeader2
{
    ...
    public partial class PMTProjectHeader2 : WebPart
    {
        ...
        public string versionNumber = "12";
        #endregion
        ...
        private void addPageJSScripts()
        {
            ...
            else if (string.Equals(Utilities.GetCurrentPageName().ToLower(), GlobalConstants.PAGE_PMFirstReview.ToLower()))
            {
                jsURL = "PMRev1";
            }
            if (jsURL != "")
