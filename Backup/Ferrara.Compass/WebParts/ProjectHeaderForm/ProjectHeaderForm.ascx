...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectHeaderForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.ProjectHeaderForm.ProjectHeaderForm" %>
...
<div class="container" id="divProjectHeader" runat="server">
    ...
    <asp:UpdatePanel ID="TitlePanel" runat="server"><ContentTemplate>
