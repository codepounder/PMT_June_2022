...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectHeaderForm_New.ascx.cs" Inherits="Ferrara.Compass.WebParts.ProjectHeaderForm_New.ProjectHeaderForm_New" %>
