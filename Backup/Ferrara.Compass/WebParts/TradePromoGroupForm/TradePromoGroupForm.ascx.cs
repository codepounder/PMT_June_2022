...
namespace Ferrara.Compass.WebParts.TradePromoGroupForm
{
    ...
    public partial class TradePromoGroupForm : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                try
                {
                    ...
                    Utilities.BindDropDownItems(ddlMaterialGroup2, GlobalConstants.LIST_MaterialGroup2Lookup, SPContext.Current.Web.Url);
        ...
        private void InitializeScreen()
        {
            ...
            if (!userMgmtService.HasReadAccess(CompassForm.TradePromo))
            {
            ...
            if (!userMgmtService.HasWriteAccess(CompassForm.TradePromo))
            {
        ...
        private void LoadFormData()
        {
            ...
            Utilities.SetDropDownValue(item.MaterialGroup2Pricing, this.ddlMaterialGroup2, this.Page);
        }
        private TradePromoGroupItem ConstructFormData()
        {
            ...
            item.MaterialGroup2Pricing = this.ddlMaterialGroup2.SelectedItem.Text;
            item.LastUpdatedFormName = CompassForm.TradePromo.ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tradePromoService.UpdateTradePromoGroupItem(item);

                var approvalItem = ConstructApprovalData();
                tradePromoService.UpdateTradePromoGroupApprovalItem(approvalItem, false);
            ...
            catch (Exception ex)
            {
                ...
                LoggingService.LogError(LoggingService.WebPartLoggingDiagnosticArea, CompassForm.TradePromo.ToString() + ": btnSave_Click: " + ex.Message);
                exceptionService.Handle(LogCategory.CriticalError, ex, CompassForm.TradePromo.ToString(), "btnSave_Click");
            }
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var approvalItem = ConstructApprovalData();
                tradePromoService.UpdateTradePromoGroupApprovalItem(approvalItem, true);

                // Complete the workflow task
                workflowService.CompleteWorkflowTask(iItemId, WorkflowStep.TradePromo);
            ...
            {
                ErrorSummary.AddError(ex.Message, this.Page);
                LoggingService.LogError(LoggingService.WebPartLoggingDiagnosticArea, CompassForm.TradePromo.ToString() + ": btnSubmit_Click: " + ex.Message);
                exceptionService.Handle(LogCategory.CriticalError, ex, CompassForm.TradePromo.ToString(), "btnSubmit_Click");
            }
        }
        #endregion
