...
namespace Ferrara.Compass.Abstractions.Constants
{
    public class CompassListFields
    {
        ...
        public const string ParentProjectNumber = "ParentProjectNumber";
        public const string Title = "Title";
        public const string CompassListItemId = "CompassListItemId";
        public const string NewIPF = "NewIPF";
        public const string PMTWorkflowVersion = "PMTWorkflowVersion";
        public const string ChangeLink = "ChangeLink";
        public const string ChangeRequestNewProjectLink = "ChangeRequestNewProjectLink";
        ...
        public const string OnHoldWorkflowPhase = "OnHoldWorkflowPhase";
        public const string PMTWorkflowUpdateStatus = "PMTWorkflowUpdateStatus";
        public const string TimelineType = "TimelineType";
        public const string TestProject = "TestProject";
        public const string PLMProject = "PLMProject";
        public const string ProfitCenter = "ProfitCenter";
        public const string FinalUpdate = "FinalUpdate";
        public const string FinalUpdate_DisplayName = "Final Update";

        public const string NewIPF_DisplayName = "New IPF";
        public const string PMTWorkflowVersion_DisplayName = "PMT Workflow Version";
        public const string ChangeLink_DisplayName = "Change Link";
        public const string ChangeRequestNewProjectLink_DisplayName = "Change Request New Project Link";
        ...
        public const string OnHoldWorkflowPhase_DisplayName = "OnHold Workflow Phase";
        public const string PMTWorkflowUpdateStatus_DisplayName = "PMT Workflow Update Status";
        public const string TimelineType_DisplayName = "Timeline Type";
        public const string TestProject_DisplayName = "Test Project?";
        public const string PLMProject_DisplayName = "PLM Project?";
        public const string ProfitCenter_DisplayName = "Profit Center";
        ...
        public const string ManuallyCreateSAPDescription = "ManuallyCreateSAPDescription";
        public const string ProductHierarchyLevel2 = "ProductHierarchyLevel2";
        public const string NoveltyProject = "NoveltyProject";
        public const string ProjectNotes = "ProjectNotes";
        public const string GenerateIPFSortOrder = "GenerateIPFSortOrder";
        public const string GenerateIPFSortOrder_DisplayName = "Generate IPF SortOrder";
        ...
        public const string PMName = "PMName";
        ...
        public const string NewFlavorColor = "NewFlavorColor";
        public const string NewNetWeight = "NewNetWeight";
        ...
        public const string ProductFormDescription = "ProductFormDescription";
        //public const string Novelty
        ...
        public const string FlowthroughDets = "FlowthroughDets";
        public const string FlowthroughDets_DisplayName = "Flowthrough Details";

        public const string LikeFGItemNumber = "LikeFGItemNumber";
        public const string LikeFGItemDescription = "LikeFGItemDescription";
        public const string OldFGItemNumber = "OldFGItemNumber";
        public const string OldFGItemDescription = "OldFGItemDescription";
        ...
        public const string NumberofTraysPerBaseUOM = "NumberofTraysPerBaseUOM";
        ...
        public const string InvolvesCarton = "InvolvesProductForm";
        public const string UnitsInsideCarton = "UnitsInsideCarton";
        public const string IndividualPouchWeight = "IndividualPouchWeight";

        public const string ReasonForChange = "ReasonForChange";
        public const string ProjectTypeSubCategory = "ProjectTypeSubCategory";
        public const string FirstShipDateMet = "FirstShipDateMet";
        public const string FirstShipDateMet_DisplayName = "First Ship Date Met?";
        ...
        public const string ManuallyCreateSAPDescription_DisplayName = "Manually Create SAP Description";
        public const string ProductHierarchyLevel2_DisplayName = "Product Hierarchy Level2";
        public const string NoveltyProject_DisplayName = "Novelty Project?";
        ...
        public const string PM_DisplayName = "PM";
        ...
        public const string PMName_DisplayName = "PM Name";
        ...
        public const string NewShape_DisplayName = "New Shape?";
        public const string NewFlavorColor_DisplayName = "New Flavor/Color?";
        public const string NewNetWeight_DisplayName = "New Net Weight?";
        ...
        public const string ProductFormDescription_DisplayName = "Product Form Description";
        ...
        public const string OldFGItemNumber_DisplayName = "Old FG Item Number";
        public const string OldFGItemDescription_DisplayName = "Old FG Item Description";
        ...
        public const string NumberofTraysPerBaseUOM_DisplayName = "Number of Trays Per Base UOM";
        ...
        public const string InvolvesCarton_DisplayName = "Involves Product Form";
        public const string UnitsInsideCarton_DisplayName = "Units Inside Carton";
        public const string IndividualPouchWeight_DisplayName = "Individual Pouch Weight";
        ...
        public const string ParentProjectNumber_DisplayName = "Parent Project Number";

        public const string ProjectTypeSubCategory_DisplayName = "Project Type SubCategory";
        public const string AllProjectUsers = "AllProjectUsers";
        public const string AllProjectUsers_DisplayName = "All Project Users";
        ...
        public const string PurchasedCandySemiNeeded = "PurchasedCandySemiNeeded";
        ...
        public const string PurchasedCandySemiNeeded_DisplayName = "Purchased Candy Semi Needed?";
