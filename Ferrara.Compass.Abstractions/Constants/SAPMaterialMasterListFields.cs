...
{
    public class SAPMaterialMasterListFields
    {
        ...
        public const string ProductHierarchyLevel1Code = "ProductHierarchyLevel1Code";
        public const string ProductHierarchyLevel1 = "ProductHierarchyLevel1";
        public const string ProductHierarchyLevel2Code = "ProductHierarchyLevel2Code";
        ...
        public const string MaterialGroup1BrandCode = "MaterialGroup1BrandCode";
        public const string MaterialGroup1Brand = "MaterialGroup1Brand";
        public const string MaterialGroup4ProductFormCode = "MaterialGroup4ProductFormCode";
        public const string MaterialGroup4ProductForm = "MaterialGroup4ProductForm";
        public const string MaterialGroup5PackTypeCode = "MaterialGroup5PackTypeCode";
        ...
        public const string MaterialType2 = "MaterialType2";
        public const string BaseQuantity = "BaseQuantity";
        public const string ZestPricingPerUnit = "ZestPricingPerUnit";
        public const string ZestPricingPerUnit_DisplayName = "Zest Pricing Per Unit";
        public const string ListPriceB1PerUnit = "ListPriceB1PerUnit";
        public const string ListPriceB1PerUnit_DisplayName = "List Price B1 Per Unit";
        ...
        public const string ProductHierarchyLevel1Code_DisplayName = "Product Hierarchy Level1 Code";
        public const string ProductHierarchyLevel1_DisplayName = "Product Hierarchy Level1";
        public const string ProductHierarchyLevel2Code_DisplayName = "Product Hierarchy Level2 Code";
        ...
        public const string MaterialGroup1BrandCode_DisplayName = "Material Group1 Brand Code";
        public const string MaterialGroup1Brand_DisplayName = "Material Group1 Brand";
        public const string MaterialGroup4ProductFormCode_DisplayName = "Material Group4 ProductForm Code";
        public const string MaterialGroup4ProductForm_DisplayName = "Material Group4 ProductForm";
        public const string MaterialGroup5PackTypeCode_DisplayName = "Material Group5 PackType Code";
        ...
        public const string MaterialType_DisplayName = "MaterialType";
        public const string MaterialType2_DisplayName = "MaterialType2";
        public const string BaseQuantity_DisplayName = "Base Quantity";
    }
}
