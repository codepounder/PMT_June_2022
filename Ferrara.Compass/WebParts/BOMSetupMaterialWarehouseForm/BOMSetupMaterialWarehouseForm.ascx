...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BOMSetupMaterialWarehouseForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.BOMSetupMaterialWarehouseForm.BOMSetupMaterialWarehouseForm" %>
...
<div class="container" id="dvcontainer" runat="server">
    <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <h1>Material Warehouse Setup</h1>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <asp:HiddenField ID="hdnProjTypeSubCategory" runat="server" />
