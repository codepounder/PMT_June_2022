...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BOMSetupProcForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.BOMSetupProcForm.BOMSetupProcForm" %>
...
<div class="container" id="dvcontainer">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <h1>Bill of Materials Creation Form - Proc</h1>
        </div>
    </div>
    <div class="row">
