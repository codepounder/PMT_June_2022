...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DistributionCenterCheckForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.DistributionCenterCheckForm.DistributionCenterCheckForm" %>
...
<div class="container" id="dvMain" runat="server">
    <div class="row">
        <div id="divAccessDenied" runat="server" class="col-xs-12 col-sm-12 col-md-12 AccessDenied">
            ...
            <asp:LinkButton ID="lbHelpDeskEmail" runat="server" CausesValidation="False" onclick="lbHelpDeskEmail_Click">HelpDesk</asp:LinkButton>.<br />        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <h1>Distribution Center Check</h1>
        </div>
    </div>
    <div class="row">
