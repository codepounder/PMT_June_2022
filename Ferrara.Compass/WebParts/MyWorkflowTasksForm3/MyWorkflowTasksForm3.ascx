...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyWorkflowTasksForm3.ascx.cs" Inherits="Ferrara.Compass.WebParts.MyWorkflowTasksForm3.MyWorkflowTasksForm3" %>
...
<script type="text/javascript" src="/_layouts/15/Ferrara.Compass/js/Compass.js?v=3"></script>
...
<div id="divImpoersonation" runat="server">
    <asp:UpdatePanel ID="upInmpersonation" runat="server">
        <ContentTemplate>
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-2">
                    <div class="form-group">
                        <SharePoint:PeopleEditor ID="peImpersonate" runat="server" AllowEmpty="false" MultiSelect="false" SelectionSet="User" />
                        <asp:HiddenField ID="hdnImpersonate" runat="server" Value="Yes" />
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-1">
                    <div class="form-group">
                        <asp:Button ID="btnImpersonate" OnClick="btnImpersonate_Click" Text="Impersonate" ClientIDMode="Static" runat="server" CssClass="ButtonControl" Style="width: auto" />
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-1">
                    <div class="form-group">
                        <asp:Button ID="btnRemove" OnClick="btnRemove_Click" Text="Remove" ClientIDMode="Static" runat="server" CssClass="ButtonControl" />
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-11">
                    <asp:Label ID="lblImpersonation" runat="server" Visible="false" Style="color: red; font-size: initial;"></asp:Label>
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
