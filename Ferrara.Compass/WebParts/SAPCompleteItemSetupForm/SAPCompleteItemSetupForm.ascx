...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SAPCompleteItemSetupForm.ascx.cs" Inherits="Ferrara.Compass.WebParts.SAPCompleteItemSetupForm.SAPCompleteItemSetupForm" %>
    ...
    <asp:PlaceHolder ID="phTopBOMSETUP" runat="server">
        <div id="dvTop" runat="server" clientidmode="Static">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6" id="divDesignateHUBDC" runat="server">
                    <div class="form-group">
