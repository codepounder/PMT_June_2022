...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompleteChildProject.aspx.cs" Inherits="Ferrara.Compass.Layouts.Ferrara.Compass.AppPages.CompleteChildProject" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript">
        function validatePage() {
            if ($('#drpFirstShipDateMet option:selected').text() == 'Select...') {
                $('.ValidationErrors').text('Please select a valid response.');
        ...
        <tr>
            <td colspan="2">
                <span class="markrequired">*</span>
                 <label id="lblFirstShipDateMet" runat="server" class="control-label">Did you meet the first ship date?</label>
                <asp:DropDownList ID="drpFirstShipDateMet" ClientIDMode="Static" CssClass="form-control" runat="server" style="width:30%">
