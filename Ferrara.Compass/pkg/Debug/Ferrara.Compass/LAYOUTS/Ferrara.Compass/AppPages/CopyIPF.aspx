...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CopyIPF.aspx.cs" Inherits="Ferrara.Compass.Layouts.Ferrara.Compass.AppPages.CopyIPF" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server"> 
    <asp:UpdatePanel ID="copyIPFPopup" runat="server" ClientIDMode="Static">
        <ContentTemplate>
