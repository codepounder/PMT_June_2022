...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadBulkFuseFiles.aspx.cs" Inherits="Ferrara.Compass.Layouts.Ferrara.Compass.AppPages.UploadBulkFuseFiles" DynamicMasterPageFile="~masterurl/default.master" %>
    ...
    <table id="TableMain" width="500px">
        ...
        <tr>
            <td style="float: left">
                ...
                <%--<asp:Label ID="lblFailedSAPNumbers" runat="server" Text="" ForeColor="Red"></asp:Label>--%>
            </td>
