...
function pageLoadCheck() {
    ...
    if (v != null && v != "") {
        ...
        if (v.indexOf('Candy') != -1 && v.indexOf('Purchased Candy') == -1) {
        ...
        } else if ((v.indexOf('Film') != -1 || v.indexOf('Corrugated') != -1) && $("#drpNew option:selected").text() == "New") {
            $("#ddlFilmPrintStyle, #ddlPrinter, #txtSpecificationNo").addClass("requireduc");
            $("#ddlFilmPrintStyle, #ddlPrinter, #txtSpecificationNo").closest(".form-group").prepend($("<span class='markrequired'>*</span>"));
        }
            ...
            $(".attachment, .ipf.hideableRow").addClass("hideItem");
            ...
            $("#ddlPrinter, #txtSpecificationNo").addClass("requireduc");
            $("#ddlPrinter, #txtSpecificationNo").closest(".form-group").prepend($("<span class='markrequired'>*</span>"));
        }
        ...
        $(".pe2, .pe3").addClass("requiredpm");
        $(".pe2, .pe3").closest(".form-group").prepend($("<span class='markrequired'>*</span>"));
        ...
        $(".drpNewExistingSpec").each(function () {
            ...
            if (el.find("option:selected").text() == "Yes") {
                if (!specNotes.hasClass("requiredpm")) {
